...
class PessoasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create pessoa" do
    assert_difference('Pessoa.count') do
      post pessoas_url, params: { pessoa: { endereco_id: @pessoa.endereco_id, pessoafisica_id: @pessoa.pessoafisica_id, pessoajuridica_id: @pessoa.pessoajuridica_id, tipo: @pessoa.tipo } }
    end
  ...
  test "should update pessoa" do
    patch pessoa_url(@pessoa), params: { pessoa: { endereco_id: @pessoa.endereco_id, pessoafisica_id: @pessoa.pessoafisica_id, pessoajuridica_id: @pessoa.pessoajuridica_id, tipo: @pessoa.tipo } }
