...
class BancosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create banco" do
    assert_difference('Banco.count') do
      post bancos_url, params: { banco: { codigo: @banco.codigo, descricao: @banco.descricao } }
    end
  ...
  test "should update banco" do
    patch banco_url(@banco), params: { banco: { codigo: @banco.codigo, descricao: @banco.descricao } }
