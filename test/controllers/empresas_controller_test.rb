...
class EmpresasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create empresa" do
    assert_difference('Empresa.count') do
      post empresas_url, params: { empresa: { endereco_id: @empresa.endereco_id, padrao: @empresa.padrao, pessoajuridica_id: @empresa.pessoajuridica_id } }
    end
  ...
  test "should update empresa" do
    patch empresa_url(@empresa), params: { empresa: { endereco_id: @empresa.endereco_id, padrao: @empresa.padrao, pessoajuridica_id: @empresa.pessoajuridica_id } }
