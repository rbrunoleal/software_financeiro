...
class FuncionariosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create funcionario" do
    assert_difference('Funcionario.count') do
      post funcionarios_url, params: { funcionario: { ativo: @funcionario.ativo, cargo_id: @funcionario.cargo_id, endereco_id: @funcionario.endereco_id, pessoafisica_id: @funcionario.pessoafisica_id } }
    end
  ...
  test "should update funcionario" do
    patch funcionario_url(@funcionario), params: { funcionario: { ativo: @funcionario.ativo, cargo_id: @funcionario.cargo_id, endereco_id: @funcionario.endereco_id, pessoafisica_id: @funcionario.pessoafisica_id } }
